...
local M = {}
local GroundDataset = torch.class('resnet.GroundDataset', M)

function GroundDataset:__init(imageInfo, opt, split)
...
function GroundDataset:_loadImage(path)
...
function GroundDataset:preprocess(opt)
   -- copied from fb.resnet.torch
