...
local M = {}
local KTHDataset = torch.class('resnet.KTHDataset', M)

function KTHDataset:__init(imageInfo, opt, split)
...
function KTHDataset:_loadImage(path)
...
function KTHDataset:preprocess(opt)
   -- copied from fb.resnet.torch
